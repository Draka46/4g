...
let table n (len_array : _ array) circ_omk : string =
    let spaces_max = if (str_len(circ_omk) > str_len("cirkel omkreds")) then str_len(circ_omk) else str_len("cirkel omkreds")
...
printfn "%s" (table n [| 1,2,3,4,5,7,8,9,10,100,1000 |] 1)